...
// AI backend: TensorFlow.js 1D-CNN (loaded dynamically client-side via AIPanel).
//
// Two classes:
...
/**
 * Build a labelled dataset from database readings.
 * Returns X (feature windows) and y (integer class labels).
 *
 * Labelling rule:
 *   signal_percentage < 30  →  Normal  (y = 0)
 *   signal_percentage ≥ 30  →  Fatigue (y = 1)
 */
