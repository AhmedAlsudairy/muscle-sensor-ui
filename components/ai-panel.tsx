...
import { Brain, Play, Square, RefreshCw, Zap, FlaskConical } from "lucide-react";
import { MuscleNet, buildDataset, shuffleIndices, WINDOW_SIZE, CLASS_LABELS } from "@/lib/neural-net";
